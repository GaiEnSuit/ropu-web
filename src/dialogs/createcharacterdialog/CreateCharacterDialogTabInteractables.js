...
const SelectedTemplate = (props) => {
  if (props.selectedTemplate === null) {
    ...
    return (
      <div>
        <Typography>{props.createCharacterDialogText.selectedTemplate}</Typography>
        ...
        <Typography>{props.createCharacterDialogText.startingInteractbles}</Typography>
        <List>
...
const TemplateList = (props) => {
  if ( props.selectedGame === null || props.selectedGame.templateInteractableListData === undefined || props.selectedGame.templateInteractableListData.length === 0) {
    return (
      <Typography>{props.createCharacterDialogText.gameNotSelected}</Typography>
    )
  } else {
...
const CreateCharacterDialogTabInteractables = (props) => {
  return (
    <div>
      ...
      <Typography>
        {
          props.selectedTemplate === null?
            (
              props.createCharacterDialogText.selectTemplate
            ) : (
              props.createCharacterDialogText.changeTemplate
            )
        }
      </Typography>
      <List>
...
export default withTabControl(withDialogControl(withGameDataControl(withCharacterDataControl(CreateCharacterDialogTabInteractables))));