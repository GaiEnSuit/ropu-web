...
const CreateCharacterDialogTabAbilities = (props) => {
  return(
    <div>
      ...
      >
        ...
        >
          <Paper>
            ...
            <Typography>
              {props.createCharacterDialogText.strength}
            </Typography>
            <Button
              onClick={()=>{
        ...
        >
          <Paper>
            ...
            <Typography>
              {props.createCharacterDialogText.endurance}
            </Typography>
            <Button
              onClick={()=>{
        ...
        >
          <Paper>
            ...
            <Typography>
              {props.createCharacterDialogText.intelligence}
            </Typography>
            <Button
              onClick={()=>{
        ...
        >
          <Paper>
            ...
            <Typography>
              {props.createCharacterDialogText.will}
            </Typography>
            <Button
              onClick={()=>{
        ...
        >
          <Paper>
            ...
            <Typography>
              {props.createCharacterDialogText.dexterity}
            </Typography>
            <Button
              onClick={()=>{
        ...
        >
          <Paper>
            ...
            <Typography>
              {props.createCharacterDialogText.agility}
            </Typography>
            <Button
              onClick={()=>{
        ...
        >
          <Paper>
            <Typography>
              {props.createCharacterDialogText.abilitiesTotal}
            </Typography>
            <TotalAbility {...props} />
          </Paper>
        </Grid>
      ...
      <Typography>
        {props.createCharacterDialogText.abilitiesTotalInstructions}
      </Typography>
      <Button>
